    ...
    <div class="row">
      ...
      <div class="col-md-8 mt-5 bg-dark text-white pl-5 ">
        ...
        <div id="message"></div>
            ...
            <span class="text-white"><h6 class="ml-5 pl-5 mt-3 mb-3">Change Password</h6></span>
            <div class="row">
             <div class="col-md-4 mt-1 ">
              <label for="exampleFormControlInput1">Current Email</label>
               
             </div>
             <div class="col-md-5 ">
               <div class="form-group">
            <input type="email" readonly name="pass" class="form-control text-white bg-dark pass" placeholder="Current Password" id="pass" value="<?= $row['email']; ?>" required>
            </div> 
             </div>
           </div>
           ...
           <div class="row">
             <div class="col-md-4 mt-1 ">
              <label for="exampleFormControlInput1">New Email ID</label>
               
             </div>
             <div class="col-md-5 ">
               <div class="form-group">
            <input type="email" name="npass" class="form-control text-white bg-dark nmail" placeholder="New Email ID" id="npass" required>
            </div> 
             </div>
           </div>
           <div class="row">
             <div class="col-md-4 mt-1 ">
              <label for="exampleFormControlInput1">Confirm Email ID</label>
               
             </div>
             <div class="col-md-5 ">
               <div class="form-group">
            <input type="email" name="cpass" class="form-control text-white bg-dark cmail" placeholder="Confirm Email ID" id="cpass" required>
            </div> 
             </div>
           </div>
    ...
    <script>
      ...
      $(document).ready(function(){
        ...
        $(".change").click(function(e){
          ...
          var nmail = $form.find(".nmail").val();
          var cmail = $form.find(".cmail").val();

         // console.log(pass,npass,cpass);

          $.ajax({
            url:"echeck.php",
            method:"post",
            data:{nmail:nmail,cmail:cmail},
            success:function(response){
