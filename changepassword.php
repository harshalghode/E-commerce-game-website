      ...
      <div class="col-md-8 mt-5 bg-dark text-white pl-5 ">
        ...
        <div id="message"></div>
            ...
            <div class="row">
             ...
             <div class="col-md-4 ">
               <div class="form-group">
            <input type="password" name="pass" class="form-control text-white bg-dark pass" placeholder="Current Password" id="pass" required>
            </div> 
             </div>
           </div>
           ...
           <div class="row">
             ...
             <div class="col-md-4 ">
               <div class="form-group">
            <input type="password" name="npass" class="form-control text-white bg-dark npass" placeholder="New Password" id="npass" required>
            </div> 
             </div>
           </div>
           <div class="row">
             ...
             <div class="col-md-4 ">
               <div class="form-group">
            <input type="password" name="cpass" class="form-control text-white bg-dark cpass" placeholder="Confirm Password" id="cpass" required>
            </div> 
             </div>
           </div>
