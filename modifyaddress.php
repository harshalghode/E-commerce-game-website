    ...
    <div class="row">
      ...
      <div class="col-md-8 mt-5 bg-dark text-white pl-5 ">
        ...
        <div id="message"></div>
            ...
            <span class="text-white"><h6 class="ml-5 pl-5 mt-3 mb-3">Modify Address</h6></span>
            <div class="row">
             <div class="col-md-4 mt-4 ">
             <label for="exampleFormControlTextarea1">Modify Address</label>
               
             </div>
             <div class="col-md-5 ">
               <div class="form-group">
            <textarea class="form-control address" id="exampleFormControlTextarea1" rows="3" placeholder="<?= $row['address']; ?>" value="" ></textarea>
            </div> 
             </div>
           </div>
